...
public class CalcutextTests
{
    ...
    public void Should_Return_Correct_PrintSentence_For_double_Inputs()
    {
        ...
        divisionResult.Should().Be($"Division of 4 by 3.5 is 1.1428571428571428");
    ...
    public void Should_Return_Correct_PrintSentence_For_IOperation_Inputs()
    {
        ...
        divisionResult.Should().Be("Division of LEFT_VALUE by RIGHT_VALUE is 0.5");
    ...
    public void Should_Return_Correct_PrintSentence_For_Complex_Inputs()
    {
        ...
        // Assert
        sumResult.Should().Be("Sum of Multiplication of 2 and 3 and Division of 4 by 5 is 6.8");
        divitionResult.Should().Be("Division of 30 by Sum of 2 and 3 is 6");
